...
void Model::init()
{
	shader = new Shader(vertexLoc, fragmentLoc,
		DirectionalLight(glm::vec3(1.0f, 1.0f, 1.0f), 0.2f, 0.2f, glm::vec3(0.0f, 0.0f, -1.0f)),
		SpecularLight(0.5f, 25.0f));
	...
	shader->addPointLight(PointLight(glm::vec3(0.0f, 0.0f, 1.0f), 0.2f, 0.2f, glm::vec3(-10.0f, 0.0f, -15.0f), 0.3f, 0.2f, 0.1f));
